      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h3 className="text-2xl font-bold text-gradient mb-2">Your Name</h3>
            <p className="text-gray-400 max-w-md">
              AI & ML Engineer | Full Stack Developer creating intelligent and innovative solutions.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <p className="text-gray-400 text-sm flex items-center">
              © {currentYear} - Made with <Heart className="h-3 w-3 mx-1 text-space-purple-light" /> by Your Name
            </p>
          </div>
        </div>
      </div>
